...
artifacts are LLM-assisted role-separated outputs rather than human expert
manual labels, so the paper states that boundary directly. Overall warning-set
precision is low; the method targets prioritization, and the main evidence is
Top-K yield, baseline lift, false-positive taxonomy, and case-study evidence.
