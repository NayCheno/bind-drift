...
def test_paper_draft_preserves_claim_boundary() -> None:
    ...
    assert "trusted binddrift-review expert protocol" in full_normalized
    ...
    assert "trusted expert double review" in full_normalized
    assert "review artifacts do not participate in primary scoring" in full_normalized
