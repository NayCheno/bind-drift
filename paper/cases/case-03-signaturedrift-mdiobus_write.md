...
`mdiobus_write` produced `W-000005` with adjudicated true-positive oracle evidence.
...
BindDrift observed `SignatureDrift` evidence for `mdiobus_write`.
...
- `/home/nya/workspace/bind-drift/.binddrift/worktrees/v6.15/rust/kernel/net/phy/reg.rs:123` in `write`
...
- `/home/nya/workspace/bind-drift/.binddrift/worktrees/v6.15/rust/kernel/net/phy/reg.rs:122` error mapping `TO_RESULT_MAPPING`
